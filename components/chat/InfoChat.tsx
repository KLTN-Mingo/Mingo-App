...
// import { ActionInput, AppModal, Avatar, Button } from "@/components/ui";
...
//     messageService
//       .getGroupDetail(conversation.id)
//       .then((detail) => {
...
//           .filter(
//             (user): user is UserMinimalDto =>
//               Boolean(user) && !existingIds.has(user.id)
//           )
//       );
//     } catch (err) {
...
//     if (!conversation?.id || selectedMemberIds.size === 0) return;

//     setAddingMembers(true);
//     try {
//       for (const memberId of selectedMemberIds) {
//         await messageService.addGroupMember(conversation.id, memberId);
//       }
...
//       Alert.alert(
//         "Add members",
//         err instanceof Error ? err.message : "Unable to add members"
//       );
//     } finally {
...
//       Alert.alert(
//         "Make admin",
//         err instanceof Error ? err.message : "Unable to promote this member"
//       );
//     }
//   };
...
//       Alert.alert(
//         "Remove admin",
//         err instanceof Error ? err.message : "Unable to demote this admin"
//       );
//     }
//   };
...
//             Alert.alert(
//               "Leave group",
//               err instanceof Error ? err.message : "Unable to leave this group"
//             );
//           }
//         },
//       },
...
//     if (!conversation?.id || updatingCategory) return;
...
//       onCategoryChange?.(conversation.id, nextCategory);
//     } catch (err: unknown) {
//       Alert.alert(
//         "Group category",
//         err instanceof Error ? err.message : "Unable to update group category"
//       );
//     } finally {
...
//                   <TagIcon
//                     size={22}
//                     color={category ? "#FFFFFF" : iconColor}
//                   />
//                 </View>
//                 <Text
//                   style={{ color: textColor, fontSize: 12, marginTop: 6 }}
//                   numberOfLines={1}
//                 >
//                   {GROUP_CATEGORIES.find((item) => item.id === category)
//                     ?.label ?? "Category"}
//                 </Text>
//               </TouchableOpacity>
//             )}
...
//                       className="flex-row items-center rounded-full bg-component-light dark:bg-component-dark px-3 py-2"
//                     >
//                       <PlusIcon size={16} color={semantic.primary} />
//                       <Text
//                         style={{
//                           color: semantic.primary,
//                           fontSize: 13,
...
//                           key={member.id}
//                           activeOpacity={
//                             isGroupAdmin && !isSelf ? 0.7 : 1
//                           }
//                           onPress={() => {
//                             if (!isGroupAdmin || isSelf) return;
...
//         onDismiss={() => {
//           if (!updatingCategory) setCategoryModalVisible(false);
//         }}
//         className="gap-4"
//       >
...
//             Group category
//           </Text>
//           <Text style={{ color: semantic.textMuted, fontSize: 13 }}>
//             Tap the selected category again to remove it.
//           </Text>
//         </View>
...
//                 }`}
//                 style={{ opacity: updatingCategory ? 0.6 : 1 }}
//               >
//                 <Text
//                   style={{
...
//         onDismiss={() => {
//           if (!addingMembers) setAddMemberModalVisible(false);
//         }}
//         className="gap-4"
//       >
//         <View className="gap-1">
...
//           leftIcon={<SearchIcon size={18} color={semantic.textMuted} />}
//         />
...
//                   className="mb-2 flex-row items-center rounded-2xl bg-component-light dark:bg-component-dark px-3 py-3"
//                 >
//                   <Avatar
//                     source={
...
//         onDismiss={() => setMemberActionVisible(false)}
//         className="gap-3"
//       >
...
//               if (member) void handlePromoteAdmin(member);
//             }}
//           >
//             Make Admin
//           </Button>
...
//               const member = selectedMember;
//               setMemberActionVisible(false);
//               if (member) void handleDemoteAdmin(member);
//             }}
//           >
//             Remove Admin
//           </Button>
    ...
    return (
      <TouchableOpacity
        ...
        style={{
          ...
          paddingHorizontal: 12,
          borderRadius: 16,
          backgroundColor: isDark ? chatTheme.bgDark : "#FFFFFF",
        }}
      >
        <Avatar
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          ...
          {member.role === "admin" && (
            <Text
              style={{ color: chatTheme.accent, fontSize: 12, marginTop: 2 }}
            >
              Admin
            </Text>
          )}
    ...
    return (
      <TouchableOpacity
        ...
        style={{
          ...
          paddingHorizontal: 12,
          borderRadius: 16,
          backgroundColor: isDark ? chatTheme.componentDark : "#FFFFFF",
          marginBottom: 8,
        }}
      >
        <Avatar
        ...
        >
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            >
              ...
              {loadingMedia ? (
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  {images.map((img) => (
                    <TouchableOpacity key={img._id} style={{ marginRight: 10 }}>
                      <Image
                        source={{ uri: img.url }}
            ...
            >
              ...
              >
                <ReportIcon size={22} color={iconColor} />
                <Text style={{ color: textColor, fontSize: 16, marginLeft: 12 }}>
                  Report
                </Text>
              </TouchableOpacity>
            ...
            {!isGroup && (
              ...
              >
                <BlockIcon size={22} color={iconColor} />
                <Text
                  style={{ color: textColor, fontSize: 16, marginLeft: 12 }}
                >
                  Block
            ...
            {isGroup && (
              ...
              >
                <View style={{ transform: [{ rotate: "180deg" }] }}>
                  <ArrowIcon size={22} color={chatTheme.dangerMuted} />
                </View>
                <Text
                  style={{
