        ...
        {isEditing ? (
          <View>
            <TextInput
              ...
              className="border border-border-light dark:border-border-dark rounded-lg p-2 text-sm font-medium"
          ...
          <>
            ...
            <TouchableOpacity
              ...
              className="mt-2"
            >
              <Text className="text-gray-500 text-sm font-medium">Close</Text>
            </TouchableOpacity>
          </>
        )}
      </View>
