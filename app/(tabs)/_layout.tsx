...
const HomeIcon = ({ color = '#6B6B6B', width = 22, height = 22 }) => (
...
const FriendIcon = ({ color = '#6B6B6B', width = 22, height = 22 }) => (
...
const MessageIcon = ({ color = '#6B6B6B', width = 22, height = 22 }) => (
...
const ProfileIcon = ({ color = '#6B6B6B', width = 22, height = 22 }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <Path
      fill="none"
